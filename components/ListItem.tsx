...
const ListItem: FC<ListItemProps> = ({ image, name, href }) => {
  ...
  return (
    <button onClick={() => onClick()} className='relative group flex items-center rounded-md overflow-hidden gap-x-4 bg-neutral-100/10 hover:bg-neutral-100/20 transition duration-75 pr-4'>
